...
(()=>{
 ...
 function init(){
  ...
  document.getElementById('coffeeLift').onclick=()=>{lifted=!lifted;const g=window.HOME_COFFEE_LIFT;if(g)g.position.y=lifted?20:0;const b=document.getElementById('coffeeLift');b.setAttribute('aria-pressed',String(lifted));b.textContent=lifted?'茶几降回日常高度 45 cm':'茶几升到用餐高度 65 cm';};
