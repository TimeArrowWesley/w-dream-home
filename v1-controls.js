...
window.addEventListener('DOMContentLoaded',()=>{
 ...
 const foot=document.querySelector('.uiSideFoot');if(foot)foot.textContent=window.HOME_MODEL_REPAIRS?'V1 R05＋MR01 · 2026.09.21 · 設計試案，尺寸待複量':'V1 R05 · 2026.09.17 · 設計示意，施工尺寸待複量';
 R.applyFinishes();
});
