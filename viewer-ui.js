...
(() => {
  ...
  function init() {
    ...
    const versions={v0:['原始格局','原始配置・BI01霧黑工業'],v1:['圓弧中島酒吧','AU01影音・BI01霧黑工業'],v2:['旋轉電視+小中島（已停用）','歷史參考・BI01配色同步'],v3:['旋轉電視+大中島','共享展示・BI01霧黑工業'],v4:['大中島','AU01影音・BI01霧黑工業']};
