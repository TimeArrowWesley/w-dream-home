...
window.addEventListener('DOMContentLoaded',()=>{
 ...
 bar.innerHTML='<span>配置</span><button data-layout="v1">V1 圓弧中島酒吧+玄關矮櫃</button><button data-proposal="v2">V2 旋轉電視+玄關高矮櫃</button><span id="layoutDescription"></span>';
