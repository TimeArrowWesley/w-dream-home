...
window.addEventListener('DOMContentLoaded',()=>{
 ...
 bar.innerHTML='<span>配置</span><button data-layout="v1">V1 圓弧中島酒吧+玄關矮櫃</button><button data-proposal="v2">V2 旋轉電視+小中島</button><button data-proposal="v3">V3 旋轉電視+大中島</button><button data-proposal="a">A 南牆電視+開放長中島</button><span id="layoutDescription"></span>';
