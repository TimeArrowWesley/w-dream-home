'use strict';
(()=>{
const version='v2',proposal=version,proposalName='V2 旋轉電視+小中島';
window.HOME_LAYOUT={displayVersion:'v4',comfort:true,version,proposal,isV2:false,entryCabinetHeight:null,entryDoorY:955};
