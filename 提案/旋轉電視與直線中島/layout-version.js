'use strict';
(()=>{
const version='v2',proposal=version,proposalName='V2 旋轉電視+玄關高矮櫃';
...
window.addEventListener('DOMContentLoaded',()=>{
 ...
 bar.innerHTML='<span>配置</span><button data-layout="v1">V1 圓弧中島酒吧+玄關矮櫃</button><button data-proposal="v2">V2 旋轉電視+玄關高矮櫃</button><button data-proposal="v3">V3 開放大中島</button><span id="layoutDescription"></span>';
