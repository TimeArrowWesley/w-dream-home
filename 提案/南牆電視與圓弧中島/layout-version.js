'use strict';
(()=>{
const version='v4',proposal=version,proposalName='V4 大中島';
window.HOME_LAYOUT={displayVersion:'v3',hybridArc:true,comfort:true,openIsland:true,fixedTV:true,version,proposal,isV2:true,entryCabinetHeight:90,entryDoorY:955};
window.addEventListener('DOMContentLoaded',()=>{
 ...
 bar.innerHTML='<span>配置</span><button data-proposal="v0">V0 原始格局</button><button data-layout="v1">V1 圓弧中島酒吧+玄關矮櫃</button><button data-proposal="v2">V2 旋轉電視+小中島</button><button data-proposal="v3">V3 旋轉電視+大中島</button><button data-proposal="v4">V4 大中島</button><span id="layoutDescription"></span>';
