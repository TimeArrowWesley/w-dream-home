...
function apply(){
 ...
 const display=window.HOME_CURRENT_VERSION?.()||version;const foot=document.querySelector?.('.uiSideFoot');if(foot)foot.textContent=display.toUpperCase()+(window.HOME_HYBRID?' · VN01圓弧中島／AU01影音／BI01材質':window.HOME_TV_WALL?' · TW01主牆／AU01影音／BI01材質':window.HOME_LIVING_AUDIO?' · AU01影音／BI01材質':' · BI01霧黑工業')+(display==='v4'?' · 已停用／歷史':' · 工程待核');
