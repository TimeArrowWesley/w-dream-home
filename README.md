...
依業主反饋重新研究22個案例，改善所有表面偏灰的問題。四版共用深煙燻棕地板、胡桃木紋收納、礦物塗料、銀拉絲、黑化鋼、黑玻與灰白織物。V1黑石弧吧；V2銀色小中島；V3銀白脈紋大中島；V4深礦石與南牆黑玻影音。保留日常／酒吧等情境、各版格局與設備功能。

[22個案例、材質前後圖與四版3D入口](材質調整.html) · [來源資料](industrial-references.json) · [設計方向與交接](設計方向.md)。`industrial-design.js` 依用途分配材質，6張小型程序紋理共用，無新增模型、動畫迴圈或貼圖下載。
