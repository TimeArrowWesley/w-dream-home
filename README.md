...
A1–14F 全屋互動設計：三個可操作配置版本、即時 3D、室內步行、設備控制，以及可編輯的家具規格清單。
...
[A 南牆電視＋開放長中島／B 展示電視屏風＋橫向中島](提案/拆收藏室替代方案/index.html)。兩案均有全屋及公共區 PNG／SVG、尺寸與平面路線檢查資料，已接至三版的「設計資料」與版本比較頁。這是尚未套用3D的討論稿，不替換 V1／V2／V3。
