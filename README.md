...
四版同步煙燻灰木地板、石墨灰大板磚、黑鈦金屬、反射黑玻、深灰木櫃與炭灰織品。照明新增日常、用餐、酒吧、電影、遊戲、夜間情境；亮度、光色與展示重點光獨立調整。主臥情境保留，畫面曝光另外控制。

[材質前後圖與四版3D入口](材質調整.html) · [設計方向與交接](設計方向.md)。程式驗證使用 `tools/verify-industrial-design.cjs`；現有模型幾何、設備與門洞維持，新增地坪貼圖重用小型灰階紋理。
