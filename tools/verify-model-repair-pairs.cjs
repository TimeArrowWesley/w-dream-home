...
(async()=>{const records=[];for(let v=1;v<=4;v++){
 ...
 }fs.writeFileSync(path.resolve('調整紀錄/20260921四版動線修正/同時開啟核對.json'),JSON.stringify({revision:'20260921-mr01',method:'Sampled source meshes; master entrance 0..90 degrees against full shower travel. Not site approval.',records},null,2)+'\n');
