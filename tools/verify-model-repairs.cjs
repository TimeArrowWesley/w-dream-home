...
const build=require('./home-test-fixture.cjs'),out=path.resolve('調整紀錄/20260921四版動線修正');fs.mkdirSync(out,{recursive:true});
...
async function main(){
 const report={revision:'20260921-mr01',date:'2026-09-21',method:'Source meshes and model coordinates; door/slider sweep samples; object extraction and 60cm proxy route. Not human, acoustic or site approval.',versions:[]};
