...
if '--install' in sys.argv:
 ...
 (project/'assets/ai-interiors/catalog.js').write_text('/* 2026-09-15: five fixed-station entry directions; three directions per other room. Shared images require identical source pixels. */\nwindow.HOME_AI_PHOTOS='+json.dumps(catalog,ensure_ascii=False,indent=2)+';\n',encoding='utf8',newline='\n')
