...
assert len(entries)==360 and {e['version'] for e in entries}=={'v0','v1','v2','v3','v4','v5'}
...
with zipfile.ZipFile(out,'w',zipfile.ZIP_DEFLATED,compresslevel=6) as z:
 for p in files:
  ...
  if name=='index.html':
   html=p.read_text(encoding='utf8').replace('../../index.html','index.html').replace('<a href="../../方案比較.html">六版格局比較 ↗</a>','<span>六版全屋 · 離線成品圖集</span>')
