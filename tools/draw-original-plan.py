...
for x,y,s in [(210,185,'主臥'),(642,125,'更衣室'),(930,220,'書房・電子琴'),(152,403,'主浴'),(490,312,'客浴'),(665,355,'儲藏室'),(-117,688,'後陽台'),(103,727,'廚房'),(345,845,'貓房'),(608,908,'玄關'),(895,700,'客廳・弧形沙發'),(500,544,'曲線中島'),(535,464,'雙面玻璃櫃')]:label(x,y,s)
d.text((70,1512),'原圖特徵：弧形沙發＋圓茶几  /  獨立貓房與弧形轉角  /  L 型書桌＋電子琴',font=font(24),fill='#233432')
